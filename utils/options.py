...
def get_parser():
    ...
    parser.add_argument('--visual_model_name', default='Engine.LLava')
    parser.add_argument('--language_model_name', default="Engine.GPT")
    parser.add_argument('--method', type=str, default='Method.VisualOnly')
    parser.add_argument('--dataset_name', default='all', choices=['all', 'PATH-VQA', 'VQA-RAD', 'Slake'])
    ...
    parser.add_argument('--truncation_50', action='store_true', default=False)
