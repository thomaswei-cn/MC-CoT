...
python run.py --method Method.MCCOT \
      ...
      --output_file_path ./outputs/qwen2/llava/MCCOT/MCCOT_PATH-VQA.jsonl
...
python run.py --method Method.MCCOT \
      ...
      --output_file_path ./outputs/qwen2/llava/MCCOT/MCCOT_VQA-RAD_open.jsonl